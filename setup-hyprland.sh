...
# flat next to this script (no subfolders):
#   ./hyprland.lua
#   ./hyprpaper.conf
#   ./mywallpaper.png
#   ./waybar-config.jsonc
...
copy_config "$SCRIPT_DIR/waybar-config.jsonc" "$HOME/.config/waybar/config.jsonc"
copy_config "$SCRIPT_DIR/waybar-style.css"    "$HOME/.config/waybar/style.css"
